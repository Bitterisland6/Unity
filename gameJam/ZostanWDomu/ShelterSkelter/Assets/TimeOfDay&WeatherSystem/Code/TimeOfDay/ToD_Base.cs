...
public class ToD_Base : MonoBehaviour 
{
    ...
    public float Set_fCurrentTimeOfDay { set { _fCurrentTimeOfDay = value * ONEHOURLENGTH; } }
    ...
    void UpdateSunAndMoon()
    {
        ...
        lSun.transform.localRotation = Quaternion.RotateTowards(lSun.transform.localRotation, 
            Quaternion.Euler((_fCurrentTimeOfDay * 360) - 90, 170, 0), 1f);
